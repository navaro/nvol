# NVOL
## Overview
NVOL is a persistent FLASH registry, often also called EEPROM emulation. NVOL provides a simple API to read and write indexed key/value pairs from a FLASH memory, like a registry. Features of NVOL include:
